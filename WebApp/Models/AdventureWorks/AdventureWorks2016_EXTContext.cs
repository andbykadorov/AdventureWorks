...
{
    public class AdventureWorks2016ExtContext : DbContext
    {
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer(@"Data Source=DESKTOP-BS7DGT8;initial catalog=AdventureWorks2016_EXT;user id=AdventureWorksAdmin;password=change;MultipleActiveResultSets=True;App=AdventureWorksPortal");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SalesOrderDetailEnlarged>(entity =>
            {
                entity.HasKey(e => new { e.SalesOrderId, e.SalesOrderDetailId });

                entity.ToTable("SalesOrderDetailEnlarged", "Sales");

                entity.HasIndex(e => e.ProductId);

                entity.HasIndex(e => e.Rowguid)
                    .HasName("AK_SalesOrderDetailEnlarged_rowguid")
                    .IsUnique();
            ...
            modelBuilder.Entity<SalesOrderHeaderEnlarged>(entity =>
            {
                entity.HasKey(e => e.SalesOrderId);

                entity.ToTable("SalesOrderHeaderEnlarged", "Sales");

                entity.HasIndex(e => e.CustomerId);

                entity.HasIndex(e => e.Rowguid)
                    .HasName("AK_SalesOrderHeaderEnlarged_rowguid")
                    .IsUnique();

                entity.HasIndex(e => e.SalesOrderNumber)
                    .HasName("AK_SalesOrderHeaderEnlarged_SalesOrderNumber")
                    .IsUnique();
                ...
                entity.Property(e => e.OnlineOrderFlag).HasColumnType("Flag");
